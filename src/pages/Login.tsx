                ...
                >
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...register('rememberMe')}
                      className="w-4 h-4 text-primary bg-white/20 border-2 border-rose-300/60 rounded focus:ring-primary/20 focus:ring-2 hover:border-rose-400/70"
                    />
                    <span className="text-sm text-warm-600 font-medium">Recordarme</span>
                  </label>
                  <button
                    type="button"
